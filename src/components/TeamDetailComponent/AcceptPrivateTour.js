...
import { addTeamInTournamentAPI, updateStatusTeamInTournament, updateTeamInScheduleAPI } from "../../api/TeamInTournamentAPI";
...
export default function AcceptPrivateTour(props) {
  const { idUser, tourDetail, setCheckRegistertour, hideShow, setHideShow,teamInTour,loading,setLoading } =
    props;
